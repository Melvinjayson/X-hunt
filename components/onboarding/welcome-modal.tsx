      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <DialogTitle className="text-2xl font-bold text-gray-900">Welcome to X-hunt!</DialogTitle>
        ...
        <div className="space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Your Adventure Awaits</h2>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-center text-gray-900">How would you like to get started?</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <Card
                className={`cursor-pointer transition-all ${
                  selectedRole === "user" ? "ring-2 ring-blue-500 bg-blue-50" : "hover:shadow-md hover:bg-gray-50"
                }`}
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
                        <h4 className="font-semibold text-gray-900">I'm an Adventurer</h4>
              ...
              <Card
                className={`cursor-pointer transition-all ${
                  selectedRole === "host" ? "ring-2 ring-green-500 bg-green-50" : "hover:shadow-md hover:bg-gray-50"
                }`}
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
                        <h4 className="font-semibold text-gray-900">I'm a Host</h4>
