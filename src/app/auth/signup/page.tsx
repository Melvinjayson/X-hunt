...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to home page or onboarding after successful registration
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="relative hidden w-0 flex-1 lg:block">
        <Image
          ...
          src="https://images.unsplash.com/photo-1603503363848-6952525df449?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
          alt="X-Hunt adventures"
          fill
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
          <h2 className="text-2xl font-bold">Join the Adventure</h2>
          <p className="mt-2">Create an account to start exploring unique experiences and earning rewards</p>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="mt-3 grid grid-cols-3 gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0"
                  >
                    <span className="sr-only">Sign up with Metamask</span>
