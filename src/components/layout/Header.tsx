...
const navigation = [
  ...
  { name: 'Host an Experience', href: '/host', current: false },
];
    ...
    <Disclosure as="nav" className="bg-white shadow">
      {({ open }) => (
        <>
              ...
              <div className="flex">
                <div className="flex flex-shrink-0 items-center">
                  <Link href="/" className="flex items-center">
                    <span className="text-xl font-bold text-primary-600">X-hunt</span>
                  </Link>
                </div>
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
                      ...
                      <div className="h-8 w-8 rounded-full bg-gradient-to-r from-primary-400 to-primary-600"></div>
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
            ...
            <div className="border-t border-gray-200 pb-3 pt-4">
              <div className="flex items-center px-4">
                <div className="flex-shrink-0">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-r from-primary-400 to-primary-600"></div>
                </div>
                <div className="ml-3">
          ...
          {/* Search overlay */}
          {isSearchOpen && (
            <div className="absolute inset-0 z-20 bg-white p-4">
